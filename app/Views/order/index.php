				...
				<table class="table align-items-center table-flush">
					<thead class="thead-light">
						<tr>
							...
							<th scope="col" class="sort">Status Pay</th>
						...
						<tr>
							...
							<?php if ($user['role'] == 'admin'): ?>
								<td>
									...
									<a href="<?= route_to('App\Controllers\ReportController::invoice', $data->id) ?>" target="_blank" class="btn btn-sm btn-secondary">Invoice</a>
